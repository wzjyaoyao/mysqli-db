...
class MysqliDb
{
    ...
    /**
     * param  array  $tableData Array of data to insert or update the desired row
     * param  string $tableName The name of the database table to work with
     * param  array  $updateColumns Limit which fields can be updated.
     */
    public function batchInsertOrUpdateOnDuplicate($tableName,$tableData,$updateColumns){
        //从data中 获取更新的字段
        if (empty($tableData)) {
            return false;
        }
        ...
        foreach ($updateColumns as $column) {
            $where_arr[] = "$column = VALUES($column)";
        }
